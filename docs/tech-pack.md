...
|---|---|---|
| D-01 | Upgrade the Odoo Online subscription to Custom for API access | **Decided 2026-09-20:** Odoo Online kept for its native bank reconciliation, Custom plan to subscribe (€37.40/user/month monthly, €29.90 yearly, odoo.com/pricing-plan). Self-hosted Community with OCA modules was evaluated and rejected Parked 2026-09-20 evening: the local Odoo 18 Community container is the ledger until the owner takes the Custom plan; the app serves the owner alone. |
